...
public static class LoggingConstants<T>
{
    ...
    public static readonly string RESOURCE_NOT_FOUND = typeof(T).Name + " with id {0} not found";
    public static readonly string RESOURCES_FILTERED_NOT_FOUND = typeof(T).Name + "s with these filters not found";

    public static readonly string RESOURCE_TO_UPDATE_NOT_FOUND = typeof(T).Name + " to update not found";
    public static readonly string RESOURCE_TO_DELETE_NOT_FOUND = typeof(T).Name + " to delete not found";
}
