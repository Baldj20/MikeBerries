...
public interface IProviderService
{
    ...
    Task<Result> DeleteProviderAsync(Guid id, ClaimsPrincipal user, CancellationToken token);
    ...
    Task<Result> UpdateProviderAsync(Guid id, ClaimsPrincipal user, ProviderModel providerModel, CancellationToken token);
}
